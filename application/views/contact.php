...
<!--            <img src="<?php echo base_url('assets/images/icons/menu-icon.png')?>" alt="Crown Floor Mills"/>-->
        ...
        <div class="grid">
            <div class="full">
                <div class="banner-holder">
                    <h1>We’re always <br><span>here for you</span></h1>
                    <article>
                        Whatever your needs or requirements, <br>
                        we value the opportunity to discuss them further.<br> Contact us to arrange a meeting and let us show you how we can give rise to your success.
                    </article>
                </div>
            </div>
        </div>
    ...
    <div class="full-screen clearfix">
        <div class="mid-screen contact-info">
            <div class="container clearfix">
                <div class="half-grid right">
                    <article>
                        <p>Mukhtar Flour Mills</p>
                        <p>446 Corniche du Fleuve. Beirut 2069-6814 Lebanon</p>
                        <p>T: +961 1 443440 - +961 1 448408 </p>
                        <p>F: +961 1 562 173</p>
                        <p>E: <a href="mailto:info@crownflourmills.com">info@crownflourmills.com</a></p>
                    </article>
                </div>
            </div>
        </div>
        <div class="mid-screen contact-form">
            <div class="container clearfix">
                <div class="half-grid left">
                    <div class="data-holder">
                        <h2>Contact <span>Us</span></h2>
                                                <form id="contact-form" action="<?php echo base_url('email/contactform')?>" method="POST">
                              <div class="row mt-5">
                                 <div class="col-md-6 ">
                                    <div class="input-holder">
                                       <input class="effect" name="first_name" id="Contact_fname" type="text" maxlength="150"required="required" />                            <label for="Contact_fname" class="required">First Name <span class="required">*</span></label>                            <span class="focus-border"></span>
                                       <div class="error"></div>
                                    </div>
                                 </div>
                                 <div class="col-md-6 ">
                                    <div class="input-holder">
                                       <input class="effect" name="last_name" id="Contact_lname" type="text" maxlength="150"required="required" />                            <label for="Contact_lname" class="required">Last Name <span class="required">*</span></label>                            <span class="focus-border"></span>
                                       <div class="error"></div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="input-holder">
                                       <select name="country" class="form-control"  id="Contact_country" required="required">
                                 ...
                                 <div class="col-md-6">
                                    <div class="input-holder">
                                       <input class="effect" name="company" id="Contact_company" type="text"required="required" />                            <label for="Contact_company" class="required">Company <span class="required">*</span></label>                            <span class="focus-border"></span>
                                       <div class="error"></div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="input-holder">
                                       <input class="effect" name="email" id="Contact_email" type="text" maxlength="150"required="required" />                            <label for="Contact_email" class="required">Email Address <span class="required">*</span></label>                            <span class="focus-border"></span>
                                       <div class="error"></div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="input-holder">
                                       <input class="effect" name="phone_number" id="Contact_phone" type="text" maxlength="30"required="required" />                            <label for="Contact_phone" class="required">Phone Number <span class="required">*</span></label>                            <span class="focus-border"></span>
                                       <div class="error"></div>
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="textarea-holder">
                                       <textarea class="effect" name="comments" id="Contact_message"required="required"style="height: 200px;"></textarea>
                                       <label for="Contact_message" class="required">Comments <span class="required">*</span></label>                            <span class="focus-border"></span>
                                       <div class="error"></div>
                                    </div>
                                 </div>
                              </div>
                              <input class="button" type="submit" name="yt0" id="send" value="Send" />
                           </form>                    </div>
                </div>
            </div>
        </div>
...
/*<![CDATA[*/
jQuery(function($) {
script.inputLabelAnimation()
script.selectboxStyle()
script.homeSlider()
});
/*]]>*/
</script>
<!-- <script>
   ...
   <script src="https://unpkg.com/leaflet@1.6.0/dist/leaflet.js" integrity="sha512-gZwIG9x3wUXg2hdXF6+rVkLF/0Vi9U8D2Ntg4Ga5I5BZpVkVxlJWbSQtXPSiUTtC0TjtGOmxa1AJPuV0CPthew==" crossorigin=""></script>  <script src="https://unpkg.com/leaflet@1.6.0/dist/leaflet.js" integrity="sha512-gZwIG9x3wUXg2hdXF6+rVkLF/0Vi9U8D2Ntg4Ga5I5BZpVkVxlJWbSQtXPSiUTtC0TjtGOmxa1AJPuV0CPthew==" crossorigin=""></script><script>
      ...
      L.marker([33.6573, 73.0572]).addTo(mymap)
      .bindPopup("<b>Mukhtar Flour Mill</b><br />.").openPopup();
      ...
      //         .openOn(mymap);
      // }
      mymap.flyTo(new L.LatLng(33.6573, 73.0572), 15);
